...
| complete/FABLE_XREF_INCORPORATION.md | Xref incorporation handoff spec (TODO-246 steps 2+3): copy-level fileset ids end to end | closed 2026-07-16 — B1–B7 shipped across 8 commits; B8 site-mirror ingest not built per D-2 default (master import stays the only checksums write path) |
