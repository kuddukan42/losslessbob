...
| complete/FABLE_VISUAL_VERIFICATION.md | Electron visual-verification driver (attempt 3) — drive the real app, resize, scale, watch progress; Wayland/NVIDIA-proof capture | shipped 2026-07-15 — bites 1–3a + 4 done (`/verify --electron`); acceptance criteria 1/2/3/5/6 met. NOT fully closed: bite 3b (progress fixture, criterion 4) deferred — see spec finding 12 + TODO-247 |
