...
| FABLE_LISTENING_INSIGHT_IDEAS.md | Listening & Insight features idea spec pack | active — §1 pairs sync + §9 tonight card shipped 07-10; §3 + §2 queued next window (WORK_PACKAGE_NEXT.md) |
...
| WORK_PACKAGE_2026-07-09.md | Agreed work package for the 7/09–7/12 usage window — timeline, locked decisions, deferred list | active — all slots landed; retire at window close |
| WORK_PACKAGE_NEXT.md | Queue for the windows after 7/12 — LISTENING §3/§2 + TODO-215 next; TODO-213 standing preempt | active |
