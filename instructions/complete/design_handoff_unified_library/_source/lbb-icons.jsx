// lbb-icons.jsx
// Lucide-style 1.5px stroke line icons. Inherit currentColor.

const LBB_ICON_PATHS = {
  // Nav
  ...
  tapematch:   "M3 10v4 M6.5 6v12 M10 3v18 M13.5 8v8 M17 5v14 M20.5 10v4",
  ...
  link:        "M10 14a4 4 0 0 0 5.66 0l3-3a4 4 0 0 0-5.66-5.66l-1 1 M14 10a4 4 0 0 0-5.66 0l-3 3a4 4 0 1 0 5.66 5.66l1-1",
  globe:       "M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z M3 12h18 M12 3a13 13 0 0 1 0 18 M12 3a13 13 0 0 0 0 18",
};

function Icon({ name, size = 16, stroke = 1.5, fill, style, ...rest }) {
  const d = LBB_ICON_PATHS[name];
  if (!d) return null;
