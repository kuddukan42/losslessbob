...
>
> **Next: C28** (`dossier_qc.py` gate G1–G9). C27 (§8 selection rules, `source[].group`),
> C26 (`backend/dossier_claims.py`, `view["claims"]`) and C25 (`dossier_anchors.py`,
> `dossier["view"]`) landed 2026-09-12.
>
