...
>
> **Next: C26** (claim engine + T4 slot templates, `backend/dossier_claims.py`). C25
> (`dossier_anchors.py`, `dossier["view"]`) landed 2026-09-12; Phase 4 (C23 / C24) before it.
>
> Nothing is pending with tj: the C19 allowlist (104/104) and the C21 generation audit are
> both signed off. The next sign-off is C27's 60% fragment threshold.
