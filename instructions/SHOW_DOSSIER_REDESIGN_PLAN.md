...
>
> **Next: C25** (`dossier_anchors.py`: `Field`, the full `ANCHORS` map, `build_view`). Phase 4
> is complete: C23 (the ten supporting parsers, `--d23` 11/11) and C24 (D-08 / D-10, `--d24`
> 6/6, runtime floor 2 min per tj) both landed 2026-09-12.
>
