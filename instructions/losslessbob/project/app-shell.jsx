...
(() => {
  ...
  // Sidebar
  // ────────────────────────────────────────────────────────────────────
  function Sidebar({ active, onNav, curatorMode }) {
    return (
      <aside style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 10.5, color: "var(--lbb-fg3)", marginTop: 2, letterSpacing: 0.04 }}>Checksum Lookup · v3.2.0</div>
          </div>
        </div>
  ...
  // Shell
  // ────────────────────────────────────────────────────────────────────
  function AppShell({ active, onNav, curatorMode, crumbs, topActions, statusExtra, children }) {
    return (
      <div style={{
