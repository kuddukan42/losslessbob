...
│   ├── test_refresh.py       # backend/refresh.py: _step_state truth table (incl. backlog-beats-watermark false-positive guard), _parse_ts cross-format regression, every registry SQL executes against a real schema, DAG integrity/no cycles, missing-table → unknown
